...
if (room_now == 1) { // Цезарь
	...
	// Получение времени
	var time = Obj_shif_unshif_1.hour
	...
	if (lo == 0) {
		if (st == 0) {
			...
			hag_1 = Obj_shi_unshif_time.pl_age + (Obj_shi_unshif_time.pl_hour * Obj_shi_unshif_time.pl_min)
			hag_2 = Obj_shi_unshif_time.pl_age - (Obj_shi_unshif_time.pl_hour * Obj_shi_unshif_time.pl_min)
